...
Actualmente la curatoría como rama de la bibliotecología es un ámbito cada vez más importante en distintos ámbitos, entre ellos, la investigación.  La curatoría refiere al proceso de selección, jerarquización y valorización de datos con el objetivo de facilitar su uso por parte de quienes recurrirán a ellos [@contreras_Curatoria_2011], aunque también incorpora el proceso de mantener la calidad de los datos, compartirlos y facilitar su reutilización [@arevalo_Importancia_2018]. Así la curatoría refiere a preparar las condiciones necesarias para el almacenamiento accesible de los datos.
...
* __Organización y practicas abiertas__: Para que un servicio de almacenamiento de datos funcione adecuadamente debe existir actitudes y conocimientos por parte de los investigadores en torno a cómo y por qué almacenar sus datos abiertamente. Del mismo modo, son necesarios algunas personas dedicadas a la administración de los repositorios en línea y a la formación de los investigadores para adecuase al contexto digital. 

En suma, para tener un buen almacenamiento de materiales sociales para investigar, que estén bien clasificados y permita encontrarlos entre los múltiples registros, es necesario tener cierta infraestructura digital y procesos de curatoría. Igualmente, estos procesos pueden apoyar la mejora de la calidad de los datos y su difusión a distintos investigadores. 
